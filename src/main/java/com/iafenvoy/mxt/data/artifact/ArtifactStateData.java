 ...
 */
public record ArtifactStateData(Optional<String> ownerUuid, Optional<Identifier> archetype,
                                double nourishment, double spiritEnergy) {
    public static final MapCodec<ArtifactStateData> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final Codec<ArtifactStateData> CODEC = MAP_CODEC.codec();
