...
public record ForgingResultData(Identifier blueprint, int finalValue, int actualSteps, int optimalSteps, int extraSteps,
                                Identifier quality) {
    public static final Codec<ForgingResultData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.fieldOf("quality").forGetter(ForgingResultData::quality)
