 ...
 */
public record ItemArchetypeDefinition(String itemType, NumberProvider spiritCapacity, NumberProvider storageSlots,
                                      NumberProvider flightSpeed, List<ResourceCost> flightCosts,
                                      List<Holder<AbilityDefinition>> grantedAbilities,
    ...
    public static final Codec<ItemArchetypeDefinition> CODEC = RecordCodecBuilder.<ItemArchetypeDefinition>create(instance -> instance.group(
            ...
            NumberProvider.CODEC.optionalFieldOf("storage_slots", new Constant(0.0D)).forGetter(ItemArchetypeDefinition::storageSlots), NumberProvider.CODEC.optionalFieldOf("flight_speed", new Constant(0.0D)).forGetter(ItemArchetypeDefinition::flightSpeed), ResourceCost.LIST_CODEC.optionalFieldOf("flight_costs", List.of()).forGetter(ItemArchetypeDefinition::flightCosts),
            AutoIgnoreListCodec.create(AbilityDefinition.HOLDER_CODEC).optionalFieldOf("granted_abilities", List.of()).forGetter(ItemArchetypeDefinition::grantedAbilities), Identifier.CODEC.optionalFieldOf("refine_behavior").forGetter(ItemArchetypeDefinition::refineBehavior)
