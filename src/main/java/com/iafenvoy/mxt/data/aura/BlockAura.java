...
public record BlockAura(List<Either<Holder<Block>, TagKey<Block>>> blocks, double auraPerBlock,
                        double regenPerTickPerBlock, Map<Identifier, Double> elementAuraPerBlock,
    ...
    public static final Codec<BlockAura> CODEC = RecordCodecBuilder.<BlockAura>create(instance -> instance.group(
            ...
            Codec.unboundedMap(Identifier.CODEC, Codec.DOUBLE).optionalFieldOf("element_aura_per_block", Map.of()).forGetter(BlockAura::elementAuraPerBlock),
            Identifier.CODEC.listOf().optionalFieldOf("environment_tags", List.of()).forGetter(BlockAura::environmentTags)
