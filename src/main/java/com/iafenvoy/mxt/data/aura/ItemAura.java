 ...
 */
public record ItemAura(List<Entry> items, Holder<Element> type, NumberProvider aura, NumberProvider consumeSpeed,
    ...
    public static final Codec<ItemAura> DIRECT_CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            Element.CODEC.fieldOf("type").forGetter(ItemAura::type),
