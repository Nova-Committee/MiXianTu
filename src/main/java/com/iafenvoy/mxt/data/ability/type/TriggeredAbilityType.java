...
public record TriggeredAbilityType(AbilityTrigger trigger, NumberProvider chance) implements AbilityType {
    public static final MapCodec<TriggeredAbilityType> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            AbilityTrigger.CODEC.fieldOf("trigger").forGetter(TriggeredAbilityType::trigger),
