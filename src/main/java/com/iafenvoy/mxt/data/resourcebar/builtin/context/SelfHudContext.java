...
public enum SelfHudContext implements ResourceBarContext {
    INSTANCE;
    ...
    public Component name(Identifier resourceId) {
        return Component.translatable("hud.mxt.resource_bar.self_hud", DefinitionText.name(resourceId, "resource"));
    }
