...
public enum TargetOverlayContext implements ResourceBarContext {
    INSTANCE;
    ...
    public Component name(Identifier resourceId) {
        return Component.translatable("hud.mxt.resource_bar.target_overlay", DefinitionText.name(resourceId, "resource"));
    }

    @Override
    public Layout layout() {
        return Layout.TARGET_OVERLAY;
    }
