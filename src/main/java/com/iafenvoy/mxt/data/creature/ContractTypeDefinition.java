 ...
 */
public record ContractTypeDefinition(List<Identifier> ownerConditions,
                                     List<Identifier> creatureConditions, Optional<Identifier> followBehavior,
    ...
    public static final Codec<ContractTypeDefinition> CODEC = RecordCodecBuilder.<ContractTypeDefinition>create(instance -> instance.group(
            Identifier.CODEC.listOf().optionalFieldOf("owner_conditions", List.of()).forGetter(ContractTypeDefinition::ownerConditions), Identifier.CODEC.listOf().optionalFieldOf("creature_conditions", List.of()).forGetter(ContractTypeDefinition::creatureConditions),
