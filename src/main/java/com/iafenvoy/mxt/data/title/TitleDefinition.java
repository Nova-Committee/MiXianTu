 ...
 */
public record TitleDefinition(List<Identifier> unlockConditions,
    ...
    public static final Codec<TitleDefinition> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.listOf().optionalFieldOf("unlock_conditions", List.of()).forGetter(TitleDefinition::unlockConditions), Codec.STRING.optionalFieldOf("translation_key", "").forGetter(TitleDefinition::translationKey),
