 ...
 */
public record SpiritRootItemEffect(Holder<SpiritRoot> spiritRoot) implements ItemEffect {
    public static final MapCodec<SpiritRootItemEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            SpiritRoot.CODEC.fieldOf("spirit_root").forGetter(SpiritRootItemEffect::spiritRoot)
