 ...
 * whatever the holder's own pool holds, fractional values included, and moves them to and from that pool on a
 * click. Whole-unit stores are a different thing and live in {@code SpiritStorageComponent} under the
 * {@code ItemAuraAccess} protocol, whose capacity comes from the item or its data rather than from a constant here.
 */
