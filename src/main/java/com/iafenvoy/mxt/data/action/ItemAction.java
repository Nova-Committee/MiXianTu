...
import com.iafenvoy.mxt.data.action.builtin.SequenceItemAction;
...
public interface ItemAction {
    Codec<ItemAction> SINGLE_CODEC = MxtTypeRegistries.ITEM_ACTION_TYPE.byNameCodec().dispatch("type", ItemAction::codec, Function.identity());
