...
public record BiomeTagBlockCondition(TagKey<Biome> tag) implements BlockCondition {
    ...
    @Override public boolean test(Level level, BlockPos pos, FormulaContext context) { return level.getBiome(pos).is(this.tag); }
    @Override public MapCodec<BiomeTagBlockCondition> codec() { return CODEC; }
}
