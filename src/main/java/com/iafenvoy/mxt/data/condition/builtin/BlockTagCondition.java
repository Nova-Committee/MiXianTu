...
public record BlockTagCondition(TagKey<Block> tag) implements BlockCondition {
    ...
    @Override public boolean test(Level level, BlockPos pos, FormulaContext context) { return level.getBlockState(pos).is(this.tag); }
    @Override public MapCodec<BlockTagCondition> codec() { return CODEC; }
}
