 ...
 */
public record ForgingMethod(int valueDelta, List<ResourceCost> costs, List<CultivationCondition> conditions,
    ...
    public static final Codec<ForgingMethod> DIRECT_CODEC = RecordCodecBuilder.<ForgingMethod>create(instance -> instance.group(
            ...
            AutoIgnoreListCodec.create(MxtTypeRegistries.CULTIVATION_CONDITION.byNameCodec()).optionalFieldOf("conditions", List.of()).forGetter(ForgingMethod::conditions),
