...
public record RealmLootCondition(EntityTarget target, Identifier realm) implements LootItemCondition {
    public static final MapCodec<RealmLootCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            Identifier.CODEC.fieldOf("realm").forGetter(RealmLootCondition::realm)
