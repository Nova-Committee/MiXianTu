...
/**
 * FTB Teams as a friend judgement source, kept behind a mod-list check so the bus can load this class without FTB
 * installed; every FTB type lives in {@link FtbTeamsRelation}. The team data is the server's rather than an
 * entity's, so FTB answers for an offline player.
 */
@EventBusSubscriber
