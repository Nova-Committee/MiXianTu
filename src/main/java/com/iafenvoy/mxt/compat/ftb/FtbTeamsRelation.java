...
/**
 * The FTB Teams half of the friend judgement: a player's team members and their allies count as their own. An
 * ally is an {@link TeamRank#ALLY} rank in the same per-team map as the members, not an allied team, and
 * {@link TeamRank#isAllyOrBetter()} is deliberately not used because it also counts {@code INVITED}.
 */
final class FtbTeamsRelation {
    ...
    // Membership is not configurable; the two outsider ranks are, because "with us" is a server's call.
