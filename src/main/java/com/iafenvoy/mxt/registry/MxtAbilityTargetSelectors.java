...
public final class MxtAbilityTargetSelectors {
    ...
    public static final DeferredHolder<MapCodec<? extends TargetSelector>, MapCodec<RayTargetSelector>> RAY = REGISTRY.register("ray", () -> RayTargetSelector.CODEC);
    public static final DeferredHolder<MapCodec<? extends TargetSelector>, MapCodec<ConeTargetSelector>> CONE = REGISTRY.register("cone", () -> ConeTargetSelector.CODEC);
    public static final DeferredHolder<MapCodec<? extends TargetSelector>, MapCodec<JsTargetSelector>> JS = REGISTRY.register("js", () -> JsTargetSelector.CODEC);
}
