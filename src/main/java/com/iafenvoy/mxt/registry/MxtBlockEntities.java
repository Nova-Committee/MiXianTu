...
public final class MxtBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TradeStationBlockEntity>> TRADE_STATION = REGISTRY.register("trade_station", () -> new BlockEntityType<>(TradeStationBlockEntity::new, MxtBlocks.TRADE_STATION.get()));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SystemStationBlockEntity>> SYSTEM_STATION = REGISTRY.register("system_station", () -> new BlockEntityType<>(SystemStationBlockEntity::new, MxtBlocks.SYSTEM_STATION.get()));
