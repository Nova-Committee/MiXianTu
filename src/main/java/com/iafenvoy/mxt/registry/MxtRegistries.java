...
public final class MxtRegistries {
    ...
    public static final DefaultedRegistry<MapCodec<? extends SecretRealmGeneration>> SECRET_REALM_GENERATION_TYPE = create("stem", MxtResourceKeys.SECRET_REALM_GENERATION_TYPE);
