...
public final class MxtTypeRegistries {
    ...
    public static final ResourceKey<Registry<Function>> FORMULA_FUNCTION_KEY = key("formula_function");
    public static final DefaultedRegistry<Function> FORMULA_FUNCTION = new DefaultedMappedRegistry<>("round", FORMULA_FUNCTION_KEY, Lifecycle.stable(), false);
    public static final ResourceKey<Registry<FormulaVariable>> FORMULA_VARIABLE_KEY = key("formula_variable");
    public static final DefaultedRegistry<FormulaVariable> FORMULA_VARIABLE = new DefaultedMappedRegistry<>("zero", FORMULA_VARIABLE_KEY, Lifecycle.stable(), false);
    ...
    public static final ResourceKey<Registry<MapCodec<? extends Badge>>> BADGE_TYPE_KEY = key("badge_type");
