...
public final class ResourceService {
    ...
    public static Result initialize(ResourceHolderComponent holder, Holder<Resource> resource, FormulaContext context) {
    ...
    public static Result initialize(ResourceHolderComponent holder, Identifier id, Resource definition, FormulaContext context) {
    ...
    public static Result change(ResourceHolderComponent holder, Holder<Resource> resource, double amount, FormulaContext context) {
        Resource definition = resource.value();
    ...
    public static Result change(ResourceHolderComponent holder, Identifier id, Resource definition, double amount, FormulaContext context) {
        return MxtDatapackRegistries.holder(MxtResourceKeys.RESOURCE, id)
                .map(resource -> change(holder, resource, amount, context)).orElse(Result.invalid());
    }

    public static Result regenerate(ResourceHolderComponent holder, Holder<Resource> resource, long elapsedTicks, FormulaContext context) {
    ...
    public static Result regenerate(ResourceHolderComponent holder, Identifier id, Resource definition, long elapsedTicks, FormulaContext context) {
        return MxtDatapackRegistries.holder(MxtResourceKeys.RESOURCE, id)
     ...
     */
    public static FormulaContext formulaContext(SpiritComponent spirit, Holder<Resource> resource, FormulaContext base) {
        Resource definition = resource.value();
    ...
    public static FormulaContext formulaContext(SpiritComponent spirit, Identifier resource, Resource definition, FormulaContext base) {
    ...
    private static int realmRank(SpiritComponent spirit, Holder<Resource> resource, Resource definition) {
