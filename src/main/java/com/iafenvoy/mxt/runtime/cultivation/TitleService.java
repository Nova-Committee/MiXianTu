...
public final class TitleService {
    ...
    public static Result grant(SpiritIdentityAttachment spirit, Identifier id, Title definition,
     ...
     */
    public static Result grant(LivingEntity entity, SpiritIdentityAttachment spirit, Identifier id, Title definition,
    ...
    public static boolean revoke(SpiritIdentityAttachment spirit, Identifier id) {
        Holder<Title> title = MxtDatapackRegistries.holder(MxtResourceKeys.TITLE, id).orElse(null);
