...
public final class TechniqueService {
    ...
    public static Result learn(SpiritAttachment spirit, Identifier id, CultivationTechnique definition, Lookup lookup) {
     ...
     */
    public static Result learn(LivingEntity entity, SpiritAttachment spirit, Identifier id, CultivationTechnique definition, Lookup lookup, FormulaContext context) {
