...
public final class CultivationAttachment extends ShouldSyncAttachment {
    ...
    public Object2DoubleMap<Holder<Resource>> cultivationProgresses() {
        return this.cultivationProgresses;
    }

    public double cultivationProgress(Holder<Resource> resource) {
        return this.cultivationProgresses.getDouble(resource);
    }

    public Map<Holder<Resource>, Holder<RealmStage>> realmStages() {
     ...
     */
    public @Nullable Holder<RealmStage> realmStage(Holder<Resource> resource) {
        return this.realmStages.get(resource);
    }
