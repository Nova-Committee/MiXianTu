...
public final class MxtTestMod {
    ...
    private static void verifyItemBindings(ServerStartedEvent event) {
        ...
        var weapon = ItemBindingService.create(Items.DIAMOND_SWORD, weaponReference)
        ...
        var pill = ItemBindingService.create(Items.HONEY_BOTTLE,
        ...
        var root = ItemBindingService.create(Items.APPLE,
        ...
        var matcherEntries = ItemMatcher.ENTRIES_CODEC.parse(JsonOps.INSTANCE, JsonParser.parseString("""
        ...
        boolean hasCopperToIron = CurrencyValueService.exchangeOffers(new net.minecraft.world.item.ItemStack(MxtItems.COPPER_COIN.get(), 10))
                .stream()
