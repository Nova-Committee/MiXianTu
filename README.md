...
| Techniques                      |   🚧   | Players can learn cultivation techniques to gain active moves or passive bonuses, and exclusion tags can stop certain techniques from being learned together; a manual is any stack carrying the `mxt:technique` component, and the mod generates a jade slip per technique. |
